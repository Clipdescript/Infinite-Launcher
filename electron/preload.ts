...
const validateLaunchOptions = (options: any): boolean => {
...
const api = {
    ...
    getModpacks: (offset?: number, limit?: number) => ipcRenderer.invoke('get-modpacks', offset, limit),
